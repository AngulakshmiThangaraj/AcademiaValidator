...
from sample_generator import create_demo_certificates, SAMPLES_DIR
...
async def process_verification(file: UploadFile = None, preset_type: str = None):
    ...
    if preset_type in ["genuine", "manipulated"]:
        sample_path = os.path.join(SAMPLES_DIR, f"certificate_{'a_genuine' if preset_type == 'genuine' else 'b_manipulated'}.jpg")
